...
public class GetAdviceUser extends Application implements PortletRequestListener {
	...
	public void init() {
		...
		mainWindow.addComponent(new AdviceComponent(mainWindow,(int) ((User) getUser()).getUserId(),(String) ((User) getUser()).getScreenName(),true));
